...
const Visitation: NextPage<IProps> = ({ visitations }: IProps) => {
  return (
    <TemplateWrapper
      ...
      desktopBackgroundImage="/images/visitation/pics/visitation_desktop_banner@2x.png"
      mobileBackgroundImage="/images/visitation/pics/visitation_mobile_banner@3x.png"
