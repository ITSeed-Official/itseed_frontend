...
const CareerSection: FC<{ data: CareerExperience[] }> = ({
  data: careerExperiences,
}) => {
          ...
          {categories.map((category: ExperienceCategory) => (
            <div
              ...
              className={classnames(
                selectedType === category && styles.selected,
            ...
            <Fragment key={category}>
              {data[category].length > 0 &&
                (selectedType === "all" || selectedType === category) && (
                  <CareerCards
                    className={classnames(
                      category !== "personalization" && styles.greenBackground
                    )}
